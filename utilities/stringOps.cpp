...
namespace stringOps
{
	...
	stringVector splitlineQuotes(const std::string &line, const std::string &delimiters, const std::string &quoteChars,delimiter_compression compression)
	{
	...
	stringVector splitlineBracket(const std::string &line, const std::string &delimiters, const std::string &bracketChars, delimiter_compression compression)
	{
		bool compress = (compression == delimiter_compression::on);
