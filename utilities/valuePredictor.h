  ...
  public:
    ...
    */
    valuePredictor (InputType input0, OutputType output0, SlopeType slope0 = SlopeType (0))
        : lastKnownInput (input0), lastKnownOutput (output0), slope (slope0)
    {
    }
     ...
     */
    virtual void setSlope (SlopeType newSlope) { slope = newSlope; }
    ...
    /** getKnownInput*/
    InputType getKnownInput () const { return lastKnownInput; }
    /** getKnownOutput*/
    OutputType getKnownOutput () const { return lastKnownOutput; }
    /** get the rate of change*/
    SlopeType getSlope () const { return slope; }
};
