...
static const std::map<std::string, std::function<double(double)>> FuncList1{
  ...
  std::make_pair ("randexp",
                  [](double val) { return gridRandom::randNumber (gridRandom::dist_type_t::exponential, val, val); })
  /* *INDENT-ON* */
};
...
static const std::map<std::string, std::function<double(double, double, double)>> FuncList3{
  ...
  std::make_pair ("hypot",
                  [](double val1, double val2, double val3) { return sqrt (val1 * val1 + val2 * val2 + val3 * val3); }),
  std::make_pair ("mag",
                  [](double val1, double val2, double val3) { return sqrt (val1 * val1 + val2 * val2 + val3 * val3); }),
...
static const std::map<std::string, std::function<double(const std::vector<double> &, const std::vector<double> &)>>
  ArrFuncList2{
    ...
    std::make_pair ("vecprod",
                    [](const std::vector<double> &ar1, const std::vector<double> &ar2) { return mult_sum (ar1, ar2); }),
    /* *INDENT-ON* */
  };
...
get2ArrayFunction (const std::string &funcName)
{
    std::string temp = convertToLowerCase (funcName);
