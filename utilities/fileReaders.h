...
public:
  ...
  timeSeries (const std::string &fname);
...
public:
  ...
  stringVec fields;	//!< container for all the strings associated with the different columns
public:
  timeSeries2 ();
  timeSeries2 (fsize_t numCols);
  timeSeries2 (fsize_t numCols, fsize_t numRows);
  timeSeries2 (const std::string &fname);
