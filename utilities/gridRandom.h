...
public:
  ...
  {
    constant, uniform, exponential, normal,lognormal, extreme_value, gamma, uniform_int,
  };
  ...
  dist_type_t getDistribution () const
  {
    return m_dist;
  }
  double operator()();
...
public:
	...
	{
		return dist(gridRandom::getEngine());
	}
	virtual void updateParameters(double param1) override
	{
		dist = DIST(param1);
	}
...
public:
	...
	virtual void updateParameters(double param1, double ) override
	{
		dist = DIST(param1);
	}
};
