...
namespace stringOps
{
	...
	*/
	stringVector splitline(const std::string &line, const std::string &delimiters = default_delim_chars, delimiter_compression compression = delimiter_compression::off);
	...
	*/
	...
	@param[in] compression default off,  if set to delimiter_compression::on will merge multiple sequential delimiters together
	*/
	void splitline(const std::string &line, stringVector &strVec, const std::string &delimiters = default_delim_chars, delimiter_compression compression = delimiter_compression::off);
	...
	*/
	stringVector splitlineQuotes(const std::string &line, const std::string &delimiters = default_delim_chars, const std::string &quoteChars=default_quote_chars, delimiter_compression compression = delimiter_compression::off);
	...
	@return a vector of strings separated by the delimiters characters accounting for bracketing characters
	*/
	stringVector splitlineBracket(const std::string &line, const std::string &delimiters = default_delim_chars, const std::string &bracketChars = default_bracket_chars, delimiter_compression compression = delimiter_compression::off);
	...
	*/
	int findCloseStringMatch(const stringVector &testStrings, const stringVector &istrings, string_match_type_t matchType = string_match_close);
