...
*/
/*
* THIS FILE WAS ALTERED BY Philip Top, 8. August 2016.
*
* - altered some class method calls to include override keyword to clear library warnings
*/
...
public:
  ...
  */
  static void setValuesenseWhiteSpace ( bool condense )
  {
  ...
  /** Return the position, in the original source file, of this node or attribute.
          ...
          (by adding or changing nodes and attributes) the new values will NOT timestepP to
...
public:
  ...
  virtual const TiXmlStylesheetReference* ToStylesheetReference () const override
  {
    return this;
  }                                                                                            ///!< Cast to a more defined type. Will return null not of the requested type.
  virtual TiXmlStylesheetReference*       ToStylesheetReference () override
  {
    return this;
  }                                                                                            ///!< Cast to a more defined type. Will return null not of the requested type.
