...
const char* fmi2GetTypesPlatform(void) 
{
 ...
 static std::mutex fmiLock; //!< lock for allowing multithreaded access
...
/* Creation and destruction of FMU instances and setting debug status */
 fmi2Component fmi2Instantiate(fmi2String instanceName, fmi2Type fmuType, fmi2String fmuGUID, fmi2String fmuResourceLocation, const fmi2CallbackFunctions* functions, fmi2Boolean visible, fmi2Boolean loggingOn)
 {
	 if (fmuType == fmi2Type::fmi2CoSimulation)
	 {
		 ...
		 try
		 {
			 ...
			 rv->first = fmiRunnerInstances.size() - 1;
 ...
 void   fmi2FreeInstance(fmi2Component comp) 
 {
	 ...
	 runner_t &runner = (p->first < fmiRunnerInstances.size()) ? fmiRunnerInstances[p->first] : fmiRunnerInstances[0];
...
/* Enter and exit initialization mode, terminate and reset */
 fmi2Status fmi2SetupExperiment(fmi2Component comp, fmi2Boolean toleranceDefined, fmi2Real tolerance, fmi2Real startTime, fmi2Boolean stopTimeDefined, fmi2Real stopTime)
 {
	 auto p = static_cast<compID *>(comp);
	 runner_t &runner = (p->first < fmiRunnerInstances.size()) ? fmiRunnerInstances[p->first] : fmiRunnerInstances[0];
	 if ((!runner) || (runner->GetID() != p->second))
...
/* Getting and setting variable values */
 ...
 fmi2Status fmi2GetInteger(fmi2Component comp, const fmi2ValueReference vr[], size_t nvr, fmi2Integer value[])
 {
	 ...
	 for (index_t ii = 0; ii < nvr; ++ii)
	 {
		 value[ii] = static_cast<int>(runner->Get(vr[ii]));
	 }
	 return fmi2OK;
 }
 fmi2Status fmi2GetBoolean(fmi2Component comp, const fmi2ValueReference vr[], size_t nvr, fmi2Boolean value[])
 {
	 ...
	 for (index_t ii = 0; ii < nvr; ++ii)
	 {
		 value[ii] = static_cast<bool>(runner->Get(vr[ii]));
	 }
	 return fmi2OK;
 }
 ...
 fmi2Status fmi2SetInteger(fmi2Component comp, const fmi2ValueReference vr[], size_t nvr, const fmi2Integer value[])
 {
	 ...
	 for (index_t ii = 0; ii < nvr; ++ii)
	 {
		 runner->Set(vr[ii], static_cast<double>(value[ii]));
	 }
	 return fmi2OK;
 }
...
/* Getting and setting the internal FMU state */
 fmi2Status fmi2GetFMUstate(fmi2Component comp, fmi2FMUstate *FMUstate)
 {
	 return fmi2Discard;
 }
 fmi2Status fmi2SetFMUstate(fmi2Component comp, fmi2FMUstate FMUstate)
 {
	 return fmi2Discard;
 }
 ...
 fmi2Status fmi2SerializeFMUstate(fmi2Component comp, fmi2FMUstate FMUstate, fmi2Byte serializedState[], size_t size)
 {
	 return fmi2Discard;
 }
 fmi2Status fmi2DeSerializeFMUstate(fmi2Component comp, const fmi2Byte serializedState[], size_t size, fmi2FMUstate *FMUstate)
 {
	 return fmi2Discard;
 }

/* Getting partial derivatives */
 fmi2Status fmi2GetDirectionalDerivative(fmi2Component comp, const fmi2ValueReference vUnknownRef[], size_t nUnknown,
	 const fmi2ValueReference vKnownRef[], size_t nKnown,
...
/* Simulating the slave */
 ...
 fmi2Status fmi2DoStep(fmi2Component comp, fmi2Real currentCommunicationPoint, fmi2Real communicationStepSize, fmi2Boolean noSetPriorPoint)
 {
	 auto p = static_cast<compID *>(comp);
	 runner_t &runner = (p->first < fmiRunnerInstances.size()) ? fmiRunnerInstances[p->first] : fmiRunnerInstances[0];
	 if ((!runner) || (runner->GetID() != p->second))
