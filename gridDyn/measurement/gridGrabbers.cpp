...
std::unique_ptr<gridGrabber> createGrabber (const std::string &fld, coreObject *obj)
{
  ...
  if (ld)
    {
      ggb = std::make_unique<objectOffsetGrabber<gridLoad>> (fld, ld);
      return ggb;
    }
  ...
  if (gen)
    {
      ...
      ggb = std::make_unique<objectOffsetGrabber<gridDynGenerator>> (fld, gen);
      return ggb;
    }
  ...
  if (lnk)
    {
      ggb = std::make_unique<objectGrabber<gridLink>> (fld, lnk);
      return ggb;
    }
  ...
  if (rel)
    {
      ggb = std::make_unique<objectGrabber<gridRelay>> (fld, rel);
      return ggb;
    }
...
std::unique_ptr<gridGrabber> createGrabber (int noffset, coreObject *obj)
{
  ...
  if (gen)
    {
      ggb = std::make_unique<objectOffsetGrabber<gridDynGenerator>> (noffset, gen);
      return ggb;
    }
  gridLoad *ld = dynamic_cast<gridLoad *> (obj);
  if (ld)
  {
	  ggb = std::make_unique<objectOffsetGrabber<gridLoad>>(noffset, ld);
	  return ggb;
  }
  return ggb;
