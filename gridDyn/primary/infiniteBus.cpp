...
void infiniteBus::updateVoltageAngle (coreTime ttime)
{
...
void infiniteBus::timestep (coreTime ttime, const IOdata &inputs, const solverMode &sMode)
{
  updateVoltageAngle (ttime);
  gridBus::timestep (ttime, inputs, sMode);
}

void infiniteBus::setState (coreTime ttime, const double state[], const double dstate_dt[], const solverMode &sMode)
{
  updateVoltageAngle (ttime);
