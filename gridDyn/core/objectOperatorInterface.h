...
{
public:
	virtual ~objectOperatorInterface()
	{
	}
	...
	@param[in] mode the update mode can be either direct which means that the given object is the new target
		or match which means that the given object is the a new container object and the existing object should be matched to something
