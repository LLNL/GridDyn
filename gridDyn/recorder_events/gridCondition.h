...
public:  
  ...
  */
  gridCondition(std::shared_ptr<gridGrabber> valGrabber = nullptr, std::shared_ptr<stateGrabber> valGrabberSt = nullptr);
  ...
  */
  void setConditionLHS(std::shared_ptr<gridGrabber> valGrabber, std::shared_ptr<stateGrabber> valGrabberSt = nullptr);
  /** load the grabbers for the Right hand side of the condition equation
  @param[in] valGrabber a gridGrabber 
  @param[in] valGrabberSt a stateGrabber default nullptr
  */
  void setConditionRHS(std::shared_ptr<gridGrabber> valGrabber, std::shared_ptr<stateGrabber> valGrabberSt = nullptr);
