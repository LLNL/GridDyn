...
void gridDynGenModel4::residual (const IOdata &inputs,
                                 const stateData &sD,
                                 double resid[],
                                 const solverMode &sMode)
{
    ...
    //   gmp[1], Vq,Vd, Pmt - Pe, gmd[2] * gm[0], gmd[3] * gm[1], (Xdp - Xqp) * gm[0] * gm[1],gm[0],gm[1],Eft);
    //   }
}
...
void gridDynGenModel4::algebraicUpdate (const IOdata &inputs,
                                        const stateData &sD,
                                        double update[],
                                        const solverMode &sMode,
                                        double /*alpha*/)
...
void gridDynGenModel4::derivative (const IOdata &inputs,
                                   const stateData &sD,
                                   double deriv[],
                                   const solverMode &sMode)
{
...
void gridDynGenModel4::jacobianElements (const IOdata &inputs,
                                         const stateData &sD,
...
stringVec gridDynGenModel4::localStateNames () const { return genModel4Names; }
