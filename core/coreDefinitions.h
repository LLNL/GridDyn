...
#include "utilities/timeRepresentation.h"
#include <cstdint>
#include <string>
#include <vector>
...
inline double operator/ (double x, coreTime t) { return x / static_cast<double> (t); }
...
inline double operator/ (coreTime t1, coreTime t2) { return static_cast<double> (t1) / static_cast<double> (t2); }

inline coreTime operator- (coreTime t, double x) { return t - coreTime (x); }

inline coreTime operator- (double x, coreTime t) { return coreTime (x) - t; }
...
inline bool operator== (coreTime t1, double rhs) { return (t1 == coreTime (rhs)); }
...
inline bool operator== (double lhs, coreTime t1) { return (coreTime (lhs) == t1); }
