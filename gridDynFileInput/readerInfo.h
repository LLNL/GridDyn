...
public:
  ...
  basicReaderInfo(const basicReaderInfo &bri) = default;
  basicReaderInfo(basicReaderInfo && bri) = default;

  basicReaderInfo &operator=(const basicReaderInfo &bri) = default;
  basicReaderInfo &operator=(basicReaderInfo && bri) = default;
...
public:
  ...
  */
  std::string checkDefines (std::string input);
