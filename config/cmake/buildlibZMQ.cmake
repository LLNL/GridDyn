...
set(trigger_build_dir ${CMAKE_BINARY_DIR}/autobuild/force_libzmq)
    ...
    set(libzmq_CMAKE_C_COMPILER "-DCMAKE_C_COMPILER=${c_compiler_string}")
    set(libzmq_CMAKE_CXX_COMPILER "-DCMAKE_CXX_COMPILER=${cxx_compiler_string}")

    if(ENABLE_AUTOBUILD_COMPILERS)
        unset(libzmq_CMAKE_C_COMPILER)
        unset(libzmq_CMAKE_CXX_COMPILER)
    endif()
...
ExternalProject_Add(libzmq
    ...
    CMAKE_ARGS
        ${libzmq_CMAKE_CXX_COMPILER}
        ${libzmq_CMAKE_C_COMPILER}
    ...
    execute_process(COMMAND ${CMAKE_COMMAND}  ${libzmq_CMAKE_CXX_COMPILER} ${libzmq_CMAKE_C_COMPILER}
