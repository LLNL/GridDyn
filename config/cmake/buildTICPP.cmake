...
function (build_ticpp)
    ...
    set(TICPP_CMAKE_C_COMPILER "-DCMAKE_C_COMPILER=${CMAKE_C_COMPILER}")
    set(TICPP_CMAKE_CXX_COMPILER "-DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}")

    if(ENABLE_AUTOBUILD_COMPILERS)
        unset(TICPP_CMAKE_C_COMPILER)
        unset(TICPP_CMAKE_CXX_COMPILER)
    endif()
...
ExternalProject_Add(ticpp
    ...
    CMAKE_ARGS 
        ...
        ${TICPP_CMAKE_CXX_COMPILER}
        ${TICPP_CMAKE_C_COMPILER}
...
message(STATUS "Configuring ticpp Autobuild for release: logging to ${PROJECT_BINARY_DIR}/logs/ticpp_autobuild_config_release.log")	
    execute_process(COMMAND ${CMAKE_COMMAND} -Wno-dev ${TICPP_CMAKE_CXX_COMPILER} ${TICPP_CMAKE_C_COMPILER} -D CMAKE_LINKER=${CMAKE_LINKER}
