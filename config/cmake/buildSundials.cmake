...
function (build_sundials)
    ...
    set(Sundials_CMAKE_C_COMPILER "${c_compiler_string}" CACHE FILEPATH "the c compiler to autobuild sundials with")
    set(Sundials_CMAKE_CXX_COMPILER "${cxx_compiler_string}" CACHE FILEPATH "the cxx compiler to autobuild sundials with")
...
ExternalProject_Add(sundials
    ...
    CMAKE_ARGS 
        ...
        -DCMAKE_C_COMPILER=${Sundials_CMAKE_C_COMPILER}
        -DCMAKE_CXX_COMPILER=${Sundials_CMAKE_CXX_COMPILER}
...
if (NOT BUILD_RELEASE_ONLY)
    ...
    execute_process(COMMAND ${CMAKE_COMMAND} -Wno-dev -D CMAKE_CXX_COMPILER=${Sundials_CMAKE_CXX_COMPILER} -D CMAKE_C_COMPILER=${Sundials_CMAKE_C_COMPILER}
