...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__griddyn

#else
#  define SWIG_init    init_griddyn

#endif
#define SWIG_name    "_griddyn"
...
# endif
  ...
  SWIG_Python_SetConstant(d, "griddyn_ok",SWIG_From_int((int)(griddyn_ok)));
  ...
  SWIG_Python_SetConstant(d, "griddyn_unknown_parameter",SWIG_From_int((int)(griddyn_unknown_parameter)));
  SWIG_Python_SetConstant(d, "griddyn_add_failure",SWIG_From_int((int)(griddyn_add_failure)));
  SWIG_Python_SetConstant(d, "griddyn_remove_failure",SWIG_From_int((int)(griddyn_remove_failure)));
  SWIG_Python_SetConstant(d, "griddyn_query_load_failure",SWIG_From_int((int)(griddyn_query_load_failure)));
  SWIG_Python_SetConstant(d, "griddyn_file_load_failure",SWIG_From_int((int)(griddyn_file_load_failure)));
  SWIG_Python_SetConstant(d, "griddyn_solve_error",SWIG_From_int((int)(griddyn_solve_error)));
  SWIG_Python_SetConstant(d, "griddyn_object_not_initialized",SWIG_From_int((int)(griddyn_object_not_initialized)));
  SWIG_Python_SetConstant(d, "griddyn_invalid_function_call",SWIG_From_int((int)(griddyn_invalid_function_call)));
  SWIG_Python_SetConstant(d, "griddyn_function_failure",SWIG_From_int((int)(griddyn_function_failure)));
  SWIG_Python_SetConstant(d, "GRIDDYN_PENDING",SWIG_From_int((int)((25))));
  SWIG_Python_SetConstant(d, "GRIDDYN_COMPLETE",SWIG_From_int((int)((30))));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
