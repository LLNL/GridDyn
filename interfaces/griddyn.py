...
def gridDynObject_setValue(obj, parameter, value, units):
    return _griddyn.gridDynObject_setValue(obj, parameter, value, units)
...
def gridDynObject_getString(*args):
    return _griddyn.gridDynObject_getString(*args)


gridDynObject_getString = _griddyn.gridDynObject_getString


def gridDynObject_getValue(obj, parameter, units, result):
    return _griddyn.gridDynObject_getValue(obj, parameter, units, result)
