...
fmiLoad::fmiLoad(std::string fmd):gridLoad("fmi_load_#")
{
	if (!fmd.empty())
	{
...
int fmiLoad::set (const std::string &param, const std::string &val)
{
...
int fmiLoad::set (const std::string &param, double val, gridUnits::units_t unitType)
{
	int out = gridLoad::set(param, val);
...
void fmiLoad::outputPartialDerivatives(const IOdata &args, const stateData *sD, arrayData<double> *ad, const solverMode &sMode)
{
	fmisub->outputPartialDerivatives(args, sD, ad, sMode);
}
void fmiLoad::ioPartialDerivatives(const IOdata &args, const stateData *sD, arrayData<double> *ad, const IOlocs &argLocs, const solverMode &sMode)
{
	fmisub->ioPartialDerivatives (args, sD, ad, argLocs,sMode);
}
void fmiLoad::jacobianElements(const IOdata &args, const stateData *sD, arrayData<double> *ad, const IOlocs &argLocs, const solverMode &sMode)
{
...
double fmiLoad::timestep(double ttime, const IOdata &args, const solverMode &sMode)
{
	prevTime = ttime;
