...
protected:
  ...
  */
  virtual void dynObjectInitializeA (unsigned long flags);
public:
  /** initialize the object.
  @param flags the optimization mode to use.
  */
  void dynInitializeA (unsigned long flags);
protected:
  /** initialize the object.
  @param flags the optimization mode to use.
  */
  virtual void dynObjectInitializeB (unsigned long flags);
public:
  /** initialize the object.
  @param flags the optimization mode to use.
  */
  void dynInitializeB (unsigned long flags);
