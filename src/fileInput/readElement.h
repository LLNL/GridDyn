...
Relay * readRelayElement (std::shared_ptr<readerElement> &element, readerInfo &ri, coreObject *searchObject = nullptr);

//zipLoad * readLoadElement (std::shared_ptr<readerElement> &element, readerInfo &ri, coreObject *searchObject = nullptr);
//Generator * readGeneratorElement (std::shared_ptr<readerElement> &element, readerInfo *ri, coreObject *searchObject = nullptr);
Link * readLinkElement (std::shared_ptr<readerElement> &element, readerInfo &ri, coreObject *searchObject = nullptr, bool warnlink = true);
Area * readAreaElement (std::shared_ptr<readerElement> &element, readerInfo &ri, coreObject *searchObject = nullptr);
...
void objSetAttributes (coreObject *obj, std::shared_ptr<readerElement> &element, const std::string &component, readerInfo &ri, const IgnoreListType &ignoreList);

void paramLoopElement (coreObject *obj, std::shared_ptr<readerElement> &element, const std::string &component, readerInfo &ri, const IgnoreListType &ignoreList);

void setParams(helperObject *obj, std::shared_ptr<readerElement> &element, const std::string &component, readerInfo &ri, const IgnoreListType &ignoreList);
void setAttributes(helperObject *obj, std::shared_ptr<readerElement> &element, const std::string &component, readerInfo &ri, const IgnoreListType &ignoreList);
...
std::string findElementName (std::shared_ptr<readerElement> &element, const std::string &ename, readerConfig::match_type matching = readerConfig::match_type::strict_case_match);
...
stringVec getElementFieldMultiple (std::shared_ptr<readerElement> &element, const std::string &ename, readerConfig::match_type matching = readerConfig::match_type::strict_case_match);
...
//This set of constants and functions is to allow templating of the object type but getting an alternative string for the 
//parent type 
