...
/** add an object to another in the hierarchy
    ...
    */
GRIDDYN_EXPORT griddyn_status gridDynObject_add(gridDynObject parentObject,
...
/** set a value parameter in an object
    ...
    @return 0 on success, negative otherwise
    */
GRIDDYN_EXPORT griddyn_status gridDynObject_setValue(gridDynObject obj,
                                                     const char* parameter,
                                                     double value);
...
GRIDDYN_EXPORT griddyn_status gridDynObject_getFlag(gridDynObject obj,
                                                    const char* flag,
                                                    int* result);
...
/** get a subobject of a particular object by type and index
    ...
    */
GRIDDYN_EXPORT gridDynObject gridDynObject_getSubObject(gridDynObject obj,
...
/** get a subobject of a particular object by type and index
    ...
    */
GRIDDYN_EXPORT gridDynObject gridDynObject_findByUserId(gridDynObject obj,
                                                        const char* componentType,
                                                        int ID);
...
GRIDDYN_EXPORT griddyn_status
    gridDynSimulation_initializeFromString(gridDynSimReference sim,
...
/** add a command to the GridDyn Command queue
    ...
    @return 0 if successful an error code otherwise
    */
GRIDDYN_EXPORT griddyn_status gridDynSimulation_addCommand(gridDynSimReference sim,
                                                           const char* command);
...
/** run the simulation to a particular time but return and run asynchronously
    ...
    @return 0 if successful an error code otherwise
    */
GRIDDYN_EXPORT griddyn_status gridDynSimulation_runToAsync(gridDynSimReference sim,
                                                           double runToTime);
...
/** get a solverKey value that can be used for the solverKey input in the other math functions
    ...
    */
GRIDDYN_EXPORT solverKey gridDynSimulation_getSolverKey(gridDynSimReference sim,
...
/** get a set of data from the simulation
    ...
    */
GRIDDYN_EXPORT int gridDynSimulation_getResults(gridDynSimReference sim,
                                                const char* dataType,
                                                double* data,
                                                int maxSize);
...
/** create a query object to retrieve a single value repeatedly
    ...
    */
GRIDDYN_EXPORT gridDynSingleQuery gridDynSingleQuery_create(gridDynObject obj,
...
/** create a query object to retrieve a set of values repeatedly
    ...
    */
GRIDDYN_EXPORT gridDynVectorQuery gridDynVectorQuery_create(gridDynObject obj,
                                                            const char* queryString);
...
/** trigger the action described by the event
    ...
    @return 0 for success or an error code representing an issue
    */
GRIDDYN_EXPORT griddyn_status gridDynEvent_setValue(gridDynEvent evnt,
                                                    const char* parameter,
                                                    double value);
