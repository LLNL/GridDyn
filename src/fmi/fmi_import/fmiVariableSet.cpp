...
size_t fmiVariableSet::getVRcount () const { return vrset.size (); }

fmi_variable_type_t fmiVariableSet::getType () const { return type.value (); }

void fmiVariableSet::push (fmi2ValueReference newvr) { vrset.push_back (newvr); }
...
void fmiVariableSet::reserve (size_t newSize) { vrset.reserve (newSize); }

void fmiVariableSet::clear () { vrset.clear (); }
