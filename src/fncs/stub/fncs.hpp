...
#define FNCS_MAKE_VERSION(major, minor, patch) ((major)*10000 + (minor)*100 + (patch))
#define FNCS_VERSION FNCS_MAKE_VERSION(FNCS_VERSION_MAJOR, FNCS_VERSION_MINOR, FNCS_VERSION_PATCH)
...
FNCS_EXPORT void
    route(const string& from, const string& to, const string& key, const string& value);
