...
namespace tcpLib {
    ...
    class TcpRxConnection: public std::enable_shared_from_this<TcpRxConnection> {
      public:
        ...
        void setErrorCall(std::function<bool(TcpRxConnection::pointer,
                                             const boost::system::error_code&)> errorFunc);
...
*/
    ...
    */
      ...
      private:
        void handle_read(size_t message_size,
                         const boost::system::error_code& error,
                         std::function<void(TcpConnection::pointer,
                                            const char*,
                                            size_t,
                                            const boost::system::error_code& error)> callback)
        {
    ...
    */
    ...
    class TcpServer: public std::enable_shared_from_this<TcpServer> {
      public:
        ...
        static pointer
            create(boost::asio::io_service& io_service, int PortNum, int nominalBufferSize = 10192);
      ...
      private:
        ...
        size_t bufferSize;
        std::function<size_t(TcpRxConnection::pointer, const char*, size_t)> dataCall;
        std::function<bool(TcpRxConnection::pointer, const boost::system::error_code& error)>
            errorCall;
