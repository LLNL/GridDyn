...
class gridComponent: public coreObject {
  ...
  public:
    ...
    */
    virtual void
        dynInitializeB(const IOdata& inputs, const IOdata& desiredOutput, IOdata& fieldSet);
...
*/
    ...
    */
    virtual void
        dynObjectInitializeB(const IOdata& inputs, const IOdata& desiredOutput, IOdata& fieldSet);
  ...
  public:
    ...
    */
    virtual void
        updateLocalCache(const IOdata& inputs, const stateData& sD, const solverMode& sMode);
    ...
    **/
    virtual IOdata
        getOutputs(const IOdata& inputs, const stateData& sD, const solverMode& sMode) const;
