...
class Relay : public gridPrimary, objectOperatorInterface
{
  ...
  public:
    ...
    */
    virtual void
    setActionMultiTrigger (index_t actionNumber, const IOlocs &multi_conditions, coreTime delayTime = timeZero);
  ...
  protected:
    ...
    */
    virtual void
    actionTaken (index_t ActionNum, index_t conditionNum, change_code actionReturn, coreTime actionTime);
  ...
  private:
    ...
    class condCheckTime
    {
      public:
        ...
        */
        condCheckTime (index_t cNum = 0, index_t aNum = 0, coreTime time = maxTime, bool mcond = false)
    ...
    class mcondTrig
    {
      public:
        ...
        coreTime delayTime = timeZero;  //!< the delay time all conditions must be true before the action is taken
  ...
  private:
    ...
    */
    change_code
    multiConditionCheckExecute (index_t conditionNum, coreTime conditionTriggerTime, coreTime minimumDelayTime);
