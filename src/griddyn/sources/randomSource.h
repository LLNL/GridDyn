    ...
    class randomSource: public rampSource {
      public:
        ...
        enum random_source_flags {
            ...
            proportional_flag =
                object_flag6,  //!< indicator that the random change is proportional to the current value
            repeated_flag =
      ...
      protected:
        ...
        std::string timeDistribution =
            "constant";  //!< string representing the time Distribution random number generation type
        std::string valDistribution =
            "constant";  //!< string representing the value Distribution random number generation type
