...
void sundialsInterface::allocate (count_t stateCount, count_t /*numRoots*/)
{
    ...
    check_flag (static_cast<void *>(state), "NVECTOR_NEW", 0);
    ...
    if (hasDifferential (mode))
    {
        ...
        check_flag (static_cast<void *>(dstate_dt), "NVECTOR_NEW", 0);
    ...
    check_flag (static_cast<void *>(abstols), "NVECTOR_NEW", 0);
    ...
    check_flag (static_cast<void *>(consData), "NVECTOR_NEW", 0);
    ...
    check_flag (static_cast<void *>(scale), "NVECTOR_NEW", 0);
    ...
    if (isDAE (mode))
    {
        ...
        check_flag (static_cast<void *>(types), "NVECTOR_NEW", 0);
