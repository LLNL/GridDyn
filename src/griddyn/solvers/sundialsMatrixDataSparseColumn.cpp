...
sundialsMatrixDataSparseColumn::sundialsMatrixDataSparseColumn (SUNMatrix mat)
    : matrixData<double> (static_cast<count_t> (SM_ROWS_S(mat)), static_cast<count_t> (SM_COLUMNS_S(mat))), J (mat)
{
}
...
count_t sundialsMatrixDataSparseColumn::size () const { return static_cast<count_t> (SM_INDEXPTRS_S(J)[colLimit ()]); }
