...
class DcBusControls {
  public:
    ...
    std::vector<Link*>
        proxyControlObject;  //!< object which act as an interface for remote objects acting on a bus
    ...
    std::vector<double>
        clinkFrac;  //!< the fraction of control power which should be allocated to a specific controllable link
