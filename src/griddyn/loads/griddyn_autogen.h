...
#define AUTOGEN_GET_SET AUTOGEN_SET \
                        AUTOGEN_GET

#define AUTOGEN_GET_SET_CUSTOM AUTOGEN_SET_WITH_CUSTOM \
                        AUTOGEN_GET_WITH_CUSTOM

#define AUTOGEN_GET_SET_FLAGS AUTOGEN_SET_FLAG \
                AUTOGEN_GET_FLAG

#define AUTOGEN_FLAGS_WITH_CUSTOM AUTOGEN_SET_FLAG_WITH_CUSTOM \
                AUTOGEN_GET_FLAG_WITH_CUSTOM

#define AUTOGEN_GET_SET_STRING AUTOGEN_GET_STRING \
                AUTOGEN_SET_STRING

#define AUTOGEN_GET_SET_STRING_WITH_CUSTOM AUTOGEN_GET_STRING_WITH_CUSTOM \
