...
public:
  ...
  virtual int fixPower(double power, double qPower, id_type_t  measureTerminal, id_type_t  fixedTerminal = 0, gridUnits::units_t unitType = gridUnits::defUnit) override final;
