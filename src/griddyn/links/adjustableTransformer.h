...
protected:
	...
	parameter_t stepDelay = 30;        //!< step control for adjusting the quantity or the time constant for continuous system
...
public:
	...
	*/
	...
	void jacobianElements(const IOdata &inputs, const stateData &sD, matrixData<double> &md, const IOlocs &inputLocs, const solverMode &sMode) override;
...
public:
	...
	void rootTrigger(coreTime time, const IOdata &inputs, const std::vector<int> &rootMask, const solverMode &sMode) override;
