...
*/
std::vector<std::shared_ptr<contingency>> buildContingencyList(gridDynSimulation *gds, const std::string &contMode, const extraContingencyInfo &info= emptyExtraInfo);
...
*/
size_t buildContingencyList(gridDynSimulation *gds, contingency_mode_t cmode, std::vector<std::shared_ptr<contingency>> &contList, const extraContingencyInfo &info = emptyExtraInfo);
