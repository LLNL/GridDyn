...
*/
int JacobianCheck (gridDynSimulation *gds, const solverMode &queryMode, double jacTol = jac_check_tol, bool useStateNames = false);
...
int algebraicCheck (gridDynSimulation *gds, coreTime time, const solverMode &sMode, double algTol = resid_check_tol, bool useStateNames = false);
...
*/
void dynamicSolverConvergenceTest (gridDynSimulation *gds, const solverMode &sMode, const std::string &file, count_t pts = 100000, int mode = 0);
