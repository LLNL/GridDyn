...
public:
  ...
  */
  ...
  virtual void delayedJacobian (const IOdata &inputs, const stateData &sD, matrixData<double> &md, const IOlocs &inputLocs, const solverMode &sMode) override;
  ...
  */
  virtual void converge (coreTime time, double state[], double dstate_dt[], const solverMode &sMode, converge_mode mode, double tol) override;
  ...
  */
  ...
  @return an index where the last value was placed
  */
  count_t getVoltage (std::vector<double> &voltages, const double state[], const solverMode &sMode, index_t start = 0) const;
  ...
  */
  ...
  @return an index where the last value was placed
  */
  count_t getAngle (std::vector<double> &angles, const double state[], const solverMode &sMode, index_t start = 0) const;
