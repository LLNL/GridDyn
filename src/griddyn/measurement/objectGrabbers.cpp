...
static const std::map<std::string, fobjectPair> objectFunctions{
  {"connected",
   {[](coreObject *obj) { return static_cast<double>(static_cast<gridComponent *>(obj)->isConnected()); },
    defunit}},
  {"enabled",
   {[](coreObject *obj) { return static_cast<double>(static_cast<gridComponent *>(obj)->isEnabled()); }, defunit}},
  {"armed",
   {[](coreObject *obj) { return static_cast<double>(static_cast<gridComponent *>(obj)->isArmed()); }, defunit}},
...
static const std::map<std::string, fvecPair> areaVecFunctions{
  ...
  {"busloadreal",
   {[](coreObject *obj, std::vector<double> &data) { return static_cast<Area *>(obj)->getBusLoadReal(data); },
    puMW}},
  {"busloadreactive",
   {[](coreObject *obj, std::vector<double> &data) { return static_cast<Area *>(obj)->getBusLoadReactive(data); },
    puMW}},
  {"linkreal",
  ...
  {"linkreactive",
   {[](coreObject *obj, std::vector<double> &data) {
    ...
    puMW}},
  {"linkloss",
   {[](coreObject *obj, std::vector<double> &data) { return static_cast<Area *>(obj)->getLinkLoss(data); }, puMW}},
...
static const std::map<std::string, descVecFunc> areaVecDescFunctions{
  ...
  {"busgenreactive", [](coreObject *obj, stringVec &desc) { return static_cast<Area *>(obj)->getBusName(desc); }},
  {"busloadreal", [](coreObject *obj, stringVec &desc) { return static_cast<Area *>(obj)->getBusName(desc); }},
  {"busloadreactive", [](coreObject *obj, stringVec &desc) { return static_cast<Area *>(obj)->getBusName(desc); }},
...
static const std::map<std::string, fobjectPair> genFunctions{
  ...
  {"adjdown", {[](coreObject *obj) { return static_cast<Generator *>(obj)->getAdjustableCapacityDown(); }, puMW}},
...
static const std::map<std::string, fobjectPair> linkFunctions{
  ...
  {"currentangle", {[](coreObject *obj) { return (static_cast<Link *>(obj)->getCurrentAngle(1)); }, rad}},
  ...
  {"currentangle2", {[](coreObject *obj) { return (static_cast<Link *>(obj)->getCurrentAngle(2)); }, rad}},
...
fobjectPair getObjectFunction(const gridComponent *comp, const std::string &field)
{
    ...
    if ((fld == "deriv") || (fld == "dodt") || (fld == "doutdt"))
    {
        return {[num](coreObject *obj) {
                    return static_cast<gridComponent *>(obj)->getDoutdt(noInputs, emptyStateData, cLocalSolverMode,
                                                                        num);
                },
                defunit};
    }
...
fvecPair getObjectVectorFunction(const gridComponent * /*comp*/, const std::string &field)
{
    if (field == "outputs")
    {
        return {[](coreObject *obj, std::vector<double> &data) {
                    auto dataoutputs =
                      static_cast<gridComponent *>(obj)->getOutputs(noInputs, emptyStateData, cLocalSolverMode);
                    data.clear();
