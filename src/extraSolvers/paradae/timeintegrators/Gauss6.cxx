...
Gauss6::Gauss6(Equation* eq):RungeKutta_Implicit(eq,false)
{
  ...
  Real sq15=sqrt(15.);
  rk_A(0,0)=Real(5./36.);rk_A(0,1)=Real(2./9.)-sq15/15.;rk_A(0,2)=Real(5./36.)-sq15/30.;
  rk_A(1,0)=Real(5./36.)+sq15/24.;rk_A(1,1)=Real(2./9.);rk_A(1,2)=Real(5./36.)-sq15/24.;
  rk_A(2,0)=Real(5./36.)+sq15/30.;rk_A(2,1)=Real(2./9.)+sq15/15.;rk_A(2,2)=Real(5./36.);
