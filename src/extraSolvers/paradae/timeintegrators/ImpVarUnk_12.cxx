...
ImpVarUnk_12::ImpVarUnk_12(Equation* eq, bool variable_step):RungeKutta_DIRK(eq,variable_step)
{
  ...
  rk_A(0,0)=1.;rk_A(0,1)=0;rk_A(0,2)=0;rk_A(0,3)=0;
  rk_A(1,0)=1.;rk_A(1,1)=0;rk_A(1,2)=0;rk_A(1,3)=0;
  rk_A(2,0)=-88./45.;rk_A(2,1)=0;rk_A(2,2)=12./5.;rk_A(2,3)=0;
  rk_A(3,0)=-407./75.;rk_A(3,1)=0;rk_A(3,2)=144./25.;rk_A(3,3)=0;
  rk_b(0)=1./10.;rk_b(1)=0;rk_b(2)=9./10.;rk_b(3)=0;
