...
typedef struct _braid_Vector_struct
{
  // Shell part
  SMultiVector tprev;      
  SVector state;        // JBS:  This "state" is I believe related either only to BDF or to root-finding.  Not a well named variable.
  
  // Vector part (this part contains actual "state" information)
  SMultiVector xprev;   /*!< This is only a list of Vectors when multistepping, otherwise it's just one vector */
  SVector dxprev;
} my_Vector;
